...
namespace CustomLayouts.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CustomLayoutsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomLayoutsEfCoreEntityExtensionMappings to extend the IdentityUser entity
